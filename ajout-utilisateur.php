 ...
 * Version: 1.0
 * Author: Stucki Floran / Carl-William Ouedraogo 
 */
 ...
 class GestionEquipe{
    ...
    public function initialize(){
        ...
        include_once(MY_PLUGIN_PATH . 'includes/pages-joueurs.php');
        include_once(MY_PLUGIN_PATH . 'includes/pages-equipes.php');
